...
class Utils {
  ...
  static returnOptionalText(title, showText) {
    return Row(
      children: [
        Text(
          title,
  ...
  static returnRaiseQueryButton(BuildContext context) {
    return InkWell(
      onTap: () async {
        ...
        try {
          ...
          _showSnackBar("Failed to open URL in browser.", context, false);
        }
      },
      child: Container(
        padding: EdgeInsets.symmetric(
            horizontal: getScreenWidth(8), vertical: getScreenHeight(8)),
